...
beforeEach(async () => {
    instance = await Airline.new()//despliega un smart contract en cada test
});
...
contract('Airline', accounts => {
    ...
    it('should allow customers to buy a flight providings its value', async() => {
        ...
        assert(price, customerFlight[1], price);
